...
tf.app.flags.DEFINE_string("deep_layers", '200,200', "deep layers")  # 0520 and 0521 ('256,128,64')  0522(512,256,128)
tf.app.flags.DEFINE_string("dropout", '0.90,0.90', "dropout rate") ## 0520(0.9 0.9 0.9)  0521(0.7 0.7 0.5)
tf.app.flags.DEFINE_boolean("batch_norm", False, "perform batch normaization (True or False)")
tf.app.flags.DEFINE_float("batch_norm_decay", 0.9, "decay for the moving average(recommend trying decay=0.9)")

tf.app.flags.DEFINE_string("data_dir", '/home/huawei/DeepFm/Data', "data dir")
...
def model_fn(features, labels, mode, params):
    ...
    with tf.variable_scope("Deep-part"):
        ...
        y_deep = tf.contrib.layers.fully_connected(inputs=deep_inputs, num_outputs=1, activation_fn=tf.identity, scope='deep_out')
...
def main(_):
    tr_files = glob.glob("%s/tr1_new.libsvm" % FLAGS.data_dir)
    ...
    if FLAGS.task_type == 'train':
        ...
        with open(FLAGS.data_dir+"/pred2.csv", "w") as fo:
